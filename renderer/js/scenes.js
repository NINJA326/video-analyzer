...
NINJA.Scenes={list:[],
 ...
 save(){NINJA.Recorder.pause('場面保存中');this.list.unshift({time:NINJA.Video.currentTime(),memo:NINJA.Comments.get(),players:[...NINJA.Players.selected],strokes:NINJA.Draw.export()});NINJA.Comments.clear();NINJA.Players.selected=[];NINJA.Players.render();this.render();U.status('場面保存しました')},
